...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .info-box { background: #fff3e0; color: #e65100; padding: 12px; border-radius: 6px; margin-bottom: 20px; font-size: 13px; }
    </style>
</head>
<body>
...
<div class="sidebar">
    ...
    <a href="../drivers/view_drivers.php">👨‍✈️ Drivers</a>
...
<div class="main">
    <h1>✏️ Edit User</h1>
    <p class="subtitle">Update user account details.</p>
    ...
    <div class="info-box">
        ⚠️ Leave password field empty if you don't want to change it.
    </div>
