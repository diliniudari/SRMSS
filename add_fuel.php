...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $query = "INSERT INTO fuel_logs 
              (vehicle_id, date, liters, cost, notes) 
              VALUES ('$vehicle_id','$date','$liters','$cost','$notes')";
...
<div class="main">
    <h1>⛽ Add Fuel Log</h1>
    <p class="subtitle">Record fuel consumption for a vehicle.</p>
    ...
    <div class="form-box">
        <form method="POST">
            ...
            <div class="form-group">
                ...
                <textarea name="notes" 
                          placeholder="e.g. Filled at Colombo depot"></textarea>
            </div>
            <button type="submit" class="btn btn-primary">Add Fuel Log</button>
            <a href="view_fuel.php" class="btn btn-secondary">Cancel</a>
        </form>
    </div>
</div>
