...
<html>
<head>
    <title>SRMSS - Edit Vehicle</title>
    <style>
...
<div class="main">
    ...
    <p class="subtitle">Update the vehicle details below.</p>
        ...
        <form method="POST">
            ...
            <div class="form-group">
                ...
                <select name="status">
                    ...
                    <option value="on_route" <?= $vehicle['status']=='on_route'?'selected':'' ?>>On Route</option>
